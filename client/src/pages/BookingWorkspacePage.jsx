...
export function BookingPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const booking = rescheduleToken
        ? await api.post(`/meetings/public/reschedule/${rescheduleToken}`, payload)
        : await api.post(`/meetings/public/event-types/${slug}/book`, payload);

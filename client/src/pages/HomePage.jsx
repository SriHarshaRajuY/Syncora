...
export function HomePage() {
  ...
  return (
    <div className="marketing-shell">
      ...
      {/* ❌ ERROR */}
      {error && <div className="banner error narrow">{error}</div>}
        ...
        <main>
          ...
          <section className="feature-grid">
            ...
            <article className="feature-panel">
              ...
              <p>Invitees pick a date, see only valid slots, answer custom questions, and confirm booking.</p>
            </article>

            <article className="feature-panel">
              <p className="eyebrow">Bonus features</p>
              <h3>Built to satisfy full assignment</h3>
